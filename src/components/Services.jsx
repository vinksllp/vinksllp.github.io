  ...
  const services = [
    {
      ...
      features: ['Web Applications', 'Mobile Apps', 'Enterprise Solutions', 'API Integration']
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      features: ['Cloud Migration', 'AWS/Azure Services', 'DevOps Setup', 'Cloud Security']
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Comprehensive database design, optimization, and maintenance services for data-driven businesses.',
    ...
    },
    {
      ...
      features: ['Quality Assurance', 'Security Audits', 'Compliance Management', 'Data Protection', 'Risk Assessment']
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ['24/7 Support', 'Bug Fixes', 'System Updates', 'Performance Monitoring']
    }
  ];
      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-secondary-600">
            Comprehensive software solutions and consulting services tailored to your industry needs
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group bg-white border border-secondary-200 rounded-xl p-8 hover:shadow-xl hover:border-primary-300 transition-all duration-300 hover:-translate-y-2"
            >
